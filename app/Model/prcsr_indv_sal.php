<?php
include "../Configuration/Connection.php"; // Archivo para traer los ids seleccionados de los checkboxes en este caso para generar el acta de salida
...
if (isset($_GET['ids']) && is_array($_GET['ids'])) {
    ...
    if (!empty($asset_data)) {
        ...
        header('Location: ../View/firma_act_indv_sal.php'); // Redirige al script del PDF
        exit;
    } else {
